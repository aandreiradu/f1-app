...
const DriverCard = (props) => {
	const {
		...
		driverProfilePic,
		driverNumber,
		driverNationalityFlag
	} = props || {};
	const teamColor =
		constructorsColors?.find((constructor) => constructor.team === constructorName)?.teamColor ||
		'';
				...
				<DriverCardNameNationality>
					...
					<DriverNationalityFlagContainer>
						<img
							src={
								driverNationalityFlag ||
								'https://www.formula1.com/content/dam/fom-website/flags/Netherlands.jpg.transform/2col-retina/image.jpg'
							}
						/>
					</DriverNationalityFlagContainer>
				</DriverCardNameNationality>
