			...
			<FooterLinksContainer>
				<FooterLinks>
					...
					<FooterLinkItem>
						...
						<FooterLinkItemText href="mailto:raduandrei697@gmail.com" target="_blank">
							Andrei Radu
						</FooterLinkItemText>
					</FooterLinkItem>
					<FooterLinkItem>
						<FooterLinkItemIcon icon={faInstagram} />
						<FooterLinkItemText href="https://www.instagram.com/aandrei.radu/" target="_blank">
							Andrei Radu
						</FooterLinkItemText>
					</FooterLinkItem>
					<FooterLinkItem>
				...
				<FooterLinks align-items="flex-end">
					...
					<FooterLinkItem>
						...
						<FooterLinkItemText font-size="14px" href="http://ergast.com/mrd/" target="_blank">
