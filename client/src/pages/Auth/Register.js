...
const Register = () => {
  ...
  const passwordInputClasses = passwordHasError
    ? `${classes["inputError"]}`
    : "";
  const firstNameInputClasses = usernameHasError
    ? `${classes["inputError"]}`
    : "";
      ...
      <form className={classes["auth-wrapper"]} onSubmit={submitFormHandler}>
        ...
        <div className={classes["auth-inputs"]}>
          ...
          <div className={classes["auth-fields"]}>
            ...
            {fullNameHasError && (
              <span className={classes.errorText}>
                Full Name should contain only letters and be at least 2
                characters long
              </span>
            )}
          </div>
          <div className={classes["auth-fields"]}>
            ...
            />
            {emailHasError && (
              <span className={classes.errorText}>Incorrect email!</span>
            )}
          </div>
          <div className={classes["auth-fields"]}>
